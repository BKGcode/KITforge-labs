...
- [x] ~~Crear BrandStrategy.md~~ ✅ APPROVED
- [ ] Decidir estructura de organización → Propuesta D presentada
- [ ] Crear PricingStrategy.md
- [ ] Crear LaunchPlaybook.md
- [ ] Crear SupportStrategy.md
- [ ] Crear _Lab/Business/_index.md
- [ ] Crear Skills/KF_MarketRules.md (tras los 4 docs de business)
- [ ] Actualizar BOOTSTRAP.md skill map
- [ ] Enriquecer KF_StorePrepRules con insights del artículo
- [ ] Review del bloque técnico
